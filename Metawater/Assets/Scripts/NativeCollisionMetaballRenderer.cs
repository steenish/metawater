...
[RequireComponent(typeof(NativeCollisionPhysicsController))]
public class NativeCollisionMetaballRenderer : MonoBehaviour {
  ...
  private NativeCollisionPhysicsController physicsController;

  void Awake() {
    meshFilter = GetComponent<MeshFilter>();
    physicsController = GetComponent<NativeCollisionPhysicsController>();
